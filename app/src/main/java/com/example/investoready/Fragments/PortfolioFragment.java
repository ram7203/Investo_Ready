...
//        Toast.makeText(home, "email: "+home.email, Toast.LENGTH_SHORT).show();
        ...
        generate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //call function
                replacefragment(new GeneratedPortfolioFragment());
            }
        });
    ...
    private void replacefragment(Fragment fragment)
    {
        ...
        fragmentTransaction.replace(R.id.portfolio_frame, fragment);
